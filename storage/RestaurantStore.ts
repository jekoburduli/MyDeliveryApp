      ...
      restaurants: [
        {
          ...
          deliveryTime: 25,
          isOpen: true,
          image: require("../../assets/Logos/Wendys-logo.png"),
          menu: [
            {
              id: "w1",
              name: "Dave’s Single",
...

        {
          ...
          deliveryTime: 20,
          isOpen: true,
          image: require("../../assets/Logos/macdonalds-logo.webp"),
...

        {
          ...
          deliveryTime: 28,
          isOpen: true,
          image: require("../../assets/Logos/kfc-logo.webp"),
          ...
          menu: [
            {
              ...
              price: 8.49,
              image: require("../../assets/Meals/chicken.avif"),
            },
            {
              id: "k2",
              name: "Zinger Burger",
...

        {
          ...
          menu: [
            ...
            },
            {
              ...
              name: "Fries",
              price: 3.49,
              image: require("../../assets/Meals/fries.webp"),
            },
            {
              id: "b4",
              name: "Milkshake",
...

        {
          ...
          deliveryTime: 15,
          isOpen: true,
          image: require("../../assets/Logos/starbucks-logo.webp"),
          ...
          menu: [
            {
              ...
              name: "Caffè Latte",
              price: 4.99,
              image: require("../../assets/Meals/coffee.webp"),
            },
            {
              id: "st2",
              name: "Cappuccino",
            ...
            },
            {
              ...
              price: 2.99,
              image: require("../../assets/Meals/muffin.webp"),
            },
          ],
        },
